...
namespace Microsoft.WindowsPhone.ImageUpdate.Tools.Common
{
  ...
  {
    [DllImport("Offreg.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall, SetLastError = true)]
    ...
    public static extern int OREnumKey(
      ...
      ref uint classnamecount,
      ref IntPtr filetimeptr);
    ...
    [DllImport("Offreg.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall, SetLastError = true)]
    public static extern int ORGetKeySecurity(
      IntPtr handle,
      SecurityInformationFlags secinfo,
      byte[] lpSecBuf,
      ref uint size);

    [DllImport("Offreg.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall, SetLastError = true)]
    public static extern int ORSetKeySecurity(
      IntPtr handle,
      SecurityInformationFlags secinfo,
      byte[] lpSecBuf);
  }
