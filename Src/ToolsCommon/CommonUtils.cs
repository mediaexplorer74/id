...
namespace Microsoft.WindowsPhone.ImageUpdate.Tools.Common
{
  public static class CommonUtils
  {
      ...
      ATTACH_VIRTUAL_DISK_FLAG attachFlags)
    {
      ...
      int error1 = VirtualDiskLib.OpenVirtualDisk(ref new VIRTUAL_STORAGE_TYPE()
      {
      ...
      }, vhdPath, accessMask, openFlags, ref new OPEN_VIRTUAL_DISK_PARAMETERS()
      {
      ...
      int error2 = VirtualDiskLib.AttachVirtualDisk(zero, IntPtr.Zero, attachFlags, 0U, ref new ATTACH_VIRTUAL_DISK_PARAMETERS()
      {
