...
namespace Microsoft.Composition.ToolBox.IO
{
	...
	public class LongPathIO
	{
		...
		public static string UNCPath(string filename)
		{
		...
		public static bool Exists(string filepath, LongPathIO.SystemType type)
		{
		...
		public static bool IsFile(FileAttributes attributes)
		{
			return (attributes & FileAttributes.Directory) != FileAttributes.Directory && attributes != (FileAttributes)(-1);
		}
		...
		public static IntPtr NullHandleValue = new IntPtr(0);
