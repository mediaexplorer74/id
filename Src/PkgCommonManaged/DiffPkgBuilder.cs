...
namespace Microsoft.WindowsPhone.ImageUpdate.PkgCommon
{
	...
	public static class DiffPkgBuilder
	{
		...
		public static DiffError CreateDiff(string sourceCab, string targetCab, DiffOptions options, Dictionary<DiffOptions, object> optionValues, string outputCab)
		{
