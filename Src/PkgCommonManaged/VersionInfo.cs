...
namespace Microsoft.WindowsPhone.ImageUpdate.PkgCommon
{
	...
	public struct VersionInfo
	{
		...
		public static VersionInfo Parse(string versionInfoString)
		{
			...
			{
				throw new ArgumentNullException("versionInfoString is null or empty", 
					"");
			}
			ArgumentException ex = new ArgumentException
				("The version info string must be in the form 'UINT16.UINT16.UINT16.UINT16'", versionInfoString);
