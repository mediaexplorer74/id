...
namespace Microsoft.WindowsPhone.ImageUpdate.PkgCommon
{
	...
	public class WPCanonicalPackage : WPPackageBase, IPkgInfo
	{
        ...
        PackageStyle IPkgInfo.Style => throw new NotImplementedException();
		...
		public static WPExtractedPackage ExtractAndLoad(string cabPath, string outputDir)
		{
			try
			{
		...
		public static WPCabPackage LoadFromCab(string cabPath)
		{
			return WPCabPackage.Load(cabPath);
		}

		// Token: 0x06000077 RID: 119 RVA: 0x000040A4 File Offset: 0x000022A4
		public static WPInstalledPackage LoadFromInstallationDir(string manifestPath, string dirRoot)
		{
