...
namespace Microsoft.WindowsPhone.ImageUpdate.PkgCommon
{
	...
	public class PkgBuilder : WPPackageBase, IPkgBuilder, IDisposable
	{
		...
		public PkgBuilder() : this(new PkgManifest())
		{
		}

		// Token: 0x0600009F RID: 159 RVA: 0x000064A3 File Offset: 0x000046A3
		public PkgBuilder(PkgManifest pkgManifest) : this(pkgManifest, null)
		{
		}

		// Token: 0x060000A0 RID: 160 RVA: 0x000064B0 File Offset: 0x000046B0
		public PkgBuilder(PkgManifest pkgManifest, string tmpDir) : base(pkgManifest)
		{
			this._tmpDir = tmpDir;
		...
		public static PkgBuilder Load(string cabPath)
		{
			string tempDirectory = FileUtils.GetTempDirectory();
