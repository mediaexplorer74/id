...
// Type: Microsoft.WindowsPhone.FeatureAPI.BootLocalePkgFile
...
{
  public class BootLocalePkgFile : PkgFile
  {
    public BootLocalePkgFile()
      : base(FeatureManifest.PackageGroups.BOOTLOCALE)
    {
    }
  }
}
