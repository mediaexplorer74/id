...
namespace FFUComponents
{
  internal class DeviceEventProvider : EventProvider
  {
      ...
      string AdditionalInfoString)
    {
      ...
      {
        byte* data = stackalloc byte[sizeof (DeviceEventProvider.EventData) * dataCount];
        DeviceEventProvider.EventData* eventDataPtr = (DeviceEventProvider.EventData*) data;
