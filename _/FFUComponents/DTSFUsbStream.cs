...
namespace FFUComponents
{
  internal class DTSFUsbStream : Stream
  {
    ...
    private unsafe IAsyncResult BeginReadInternal(
      ...
      object stateObject)
    {
      DTSFUsbStreamReadAsyncResult ar = new DTSFUsbStreamReadAsyncResult(userCallback, stateObject)
      {
        Buffer = buffer,
        Offset = offset,
        Count = count,
      ...
      NativeOverlapped* nativeOverlappedPtr = new Overlapped(0, 0, IntPtr.Zero, (IAsyncResult) ar).Pack(new IOCompletionCallback(this.ReadIOCompletionCallback), (object) buffer);
    ...
    private unsafe IAsyncResult BeginWriteInternal(
      ...
      object stateObject)
    {
      DTSFUsbStreamWriteAsyncResult ar = new DTSFUsbStreamWriteAsyncResult(userCallback, stateObject)
      {
        Buffer = buffer,
        Offset = offset,
        Count = count,
      ...
      NativeOverlapped* nativeOverlappedPtr = new Overlapped(0, 0, IntPtr.Zero, (IAsyncResult) ar).Pack(new IOCompletionCallback(this.WriteIOCompletionCallback), (object) buffer);
      fixed (byte* numPtr = buffer)
      {
