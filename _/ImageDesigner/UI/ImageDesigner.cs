...
{
  public class ImageDesigner : Window, IComponentConnector
  {
    ...
    private void Window_Closing(object sender, CancelEventArgs e) => IDContext.Instance.Controller.OnApplicationExit();
