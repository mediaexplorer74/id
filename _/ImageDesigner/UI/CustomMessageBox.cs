...
{
  public class CustomMessageBox : Window, IComponentConnector
  {
    ...
    public static bool? ShowMessage(string title, string message) => new CustomMessageBox(new CustomMessageBoxVM(CustomDialogType.OKDialog)
    {
      Header = title,
      Message = message,
      Width = 300
    ...
    public static bool? ShowError(WPIDException e) => CustomMessageBox.ShowError(e.MessageTrace);
    ...
    public static bool? ShowMessage(string header, string message, int height = 400, int width = 400) => new CustomMessageBox(new CustomMessageBoxVM(CustomDialogType.OKDialog)
    {
      Header = header,
      Message = message,
      Height = height,
    ...
    private void Window_Loaded(object sender, RoutedEventArgs e) => (this.DataContext as CustomMessageBoxVM).OnLoad();
